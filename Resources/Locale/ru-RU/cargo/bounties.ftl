...
bounty-description-clown-costume = Из-за недавнего инцидента в контактном зоопарке космических карпов мы, к сожалению, потеряли клоуна Бонобобонобо. Пришлите нам новый костюм, чтобы дети снова могли его увидеть.
bounty-description-oven-machine-board = Нам нужна ещё одна печь, чтобы ускорить готовку. Не могли бы вы прислать плату? Мистер Гигглз будет очень доволен.
bounty-description-rollerskates = Служба безопасности ЦентКома предлагает новую стратегию, которая поможет офицерам побеждать в пеших погонях. Пришлите им пару роликов, чтобы они поняли, насколько это плохая идея.
