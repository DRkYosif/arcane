...
reagent-desc-necrosol = Некротическое вещество, которое, похоже, способно исцелять замёрзшие трупы. В малых дозах лечит и омолаживает растения.
reagent-desc-warfarin = Часто используется как антикоагулянт. Затрудняет свёртывание крови. При передозировке может вызвать внутреннее кровотечение.
