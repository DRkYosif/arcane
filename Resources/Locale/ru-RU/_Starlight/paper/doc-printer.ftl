...
doc-text-printer-arrest-report =
   ...
   ⠀⠀ [bold]ОТЧЕТ ОБ АРЕСТЕ[/bold]
    ...
    Арестованный был: [проверка] задержан; [check] условно-досрочно освобожден; [check] выпущено
...
doc-text-printer-invocation =
   ...
   ⠀[form] настоящим просит [signature] появиться в [форме] без промедления.
...
doc-text-printer-request-change-salary =
   ...
   ⠀⠀ [bold]ЗАПРОС НА ИЗМЕНЕНИЕ ЗАРАБОТКИ[/bold]
    ...
    Я, [signature], настоящим о повышении/уменьшении заработной платы в [форме] (сумме или процентах).
